...
<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-side">
    ...
    >
      ...
      <!-- Visible only if userRole === "administrator" -->
      {#if userRole === "administrator"}
        ...
        <li>
          <a
            ...
            onclick={closeDrawer}
          >
            <!-- New heroicon for Agent Management -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
      ...
      <li>
        <a
          ...
          onclick={closeDrawer}
        >
          <!-- New heroicon for Knowledge Base -->
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <!-- If userRole === "employee" or "administrator" -->
      {#if userRole === "employee" || userRole === "administrator"}
        <li>
          <a
            ...
            onclick={closeDrawer}
          >
            <!-- Same heroicon for Agent Live Chat -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
